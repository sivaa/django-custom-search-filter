...
DATABASES = {
    'default': {
        ...
        'NAME': 'D:\\Python\\ws\\django-custom-search-filter\\sqlite2.db',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = ')909lmtz5xrl(g)p+5ed4l$80ehbwt-4u((&amp;%gx9!z%jtb&amp;w9h'
